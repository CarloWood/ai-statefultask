...
void AIFrameTimer::create(std::chrono::stable_clock::time_point Interval, std::function<void()> callback)
{
...
void AIFrameTimer::call(std::chrono::stable_clock::time_point interval)
{
